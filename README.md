...
- [3.资源说明，处理及反馈途径和准则](#3资源说明_处理及反馈途径和准则)
    - [关于音乐和广播剧](#关于音乐和广播剧)
    - [应急措施及md5表](#应急措施及md5表)
  - [a.Onedrive盘（更新最快，其他均为延时分流）](#a-onedrive)
  - [b.磁力种子（欢迎大佬制其他资源的种并保种续种）](#b-magnet)
  - [c.百度网盘（260524已复活并升级）](#c-baidu)
...
打包的资源理论上基本不会出问题，而如果压缩包有密码且没注明，请尝试**ef-a 或 终点 或 神代小祈@天使动漫**。

### 应急措施及md5表

1. 目前而言，提供了两个大的下载渠道，如果使用的那个出了问题请尝试另一个 **（注：除了260524复活版，本文档内其余毒盘链接停止维护且不接受反馈）**。另外，网盘内压缩包全部采用rar+rr3及以上的方式进行存储，如果下载的压缩包提示损坏，请使用**winrar等高级解压软件**进行修复；若修复无效，请[核对md5列表以排查网络原因](https://github.com/Seshiria/EFmd5sum/blob/master/md5sum)
(不会请百度)。
...
[确保看完5.特殊问题解决](#5特殊问题解决)以及[搜索后无相关讨论或讨论没给出解决方案](https://github.com/devil233-ui/ef_collection/issues)再进行提Issue **（注：毒盘复活版请直接写邮件给@神代小祈：369325980@qq.com）**。反馈时请明确指出 1.所属媒体（动画、游戏小说等）2.目标网盘 3.目标文件 4.目标语言 要么给出完整路径，要么截图，否则恕不处理并直接关闭ISSUE。
...
第三代管理者@神代小祈：369325980@qq.com

260524复活版总链：https://pan.baidu.com/s/1WjLxE1tEGktdG0gc6HkbgQ?pwd=d6mj

以下为其本人原话：

>>> 大部分都按照OD原档备份了，文件夹命名部分我按自己方式重新做了整理。就是视频部分，我有些没备份，也有部分补增，例如DVD相关，还有日版BDMV，具体可以看文件，BDrip我附带了和BDMV的截图，>>> 有需要可以自己下载对比，字幕也重新整理了一下，具体废话写了不少
